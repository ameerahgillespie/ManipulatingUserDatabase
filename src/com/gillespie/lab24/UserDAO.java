...
import com.gillespie.lab24.UserDAO;
...
public class UserDAO {
	...
	public static List<User> getUsersByCategory(String cat){
		if (factory == null)
			setupFactory();
		 // Get current session
		 Session hibernateSession = factory.openSession();
		 ...
		 //deprecated method & unsafe cast
         List<User> users = hibernateSession.createQuery("SELECT " + cat + " FROM User").list(); 
